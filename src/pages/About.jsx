        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-slate-900">
              ...
              <span className={`text-${accentColor}-600`}>Tourist and Traveler</span>
            </h2>
            ...
            <p className="text-slate-600 mb-8 leading-relaxed">
              From the Himalayas to Kerala’s backwaters, we provide trusted information so you can travel with confidence.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              We prioritize your experience above all else.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className={`p-8 rounded-2xl bg-slate-800 border border-slate-700 hover:border-${accentColor}-500 transition-colors group`}>
              ...
              <p className="text-slate-400 leading-relaxed">
                Updated routes, ticket prices, and entry timings.
              </p>
            </div>
            ...
            <div className={`p-8 rounded-2xl bg-slate-800 border border-slate-700 hover:border-${accentColor}-500 transition-colors group`}>
              ...
              <p className="text-slate-400 leading-relaxed">
                AI-driven travel plans based on your style.
              </p>
            </div>
            ...
            <div className={`p-8 rounded-2xl bg-slate-800 border border-slate-700 hover:border-${accentColor}-500 transition-colors group`}>
              ...
              <p className="text-slate-400 leading-relaxed">
                Thousands of real-time reviews and travel hacks.
              </p>
            </div>
