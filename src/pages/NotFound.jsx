...
export default function NotFound() {
  ...
  return (
    <section className="max-w-2xl mx-auto px-6 py-24 text-center">
      <p className="text-sm font-semibold text-[#a8523b]">404</p>
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        <Link to="/ranthambore-safari-tours" className="rounded-full bg-[#a8523b] px-5 py-2.5 font-semibold text-white">
