...
import logo from "../assets/BharatMile-Logo-96.webp"; // 96px WebP (~1 KB) for a ~40px logo
...
// Only homepage should have transparent navbar at top
  ...
  return (
    <>
      <style>{`
        ...
        .navbar.top .nav-hamburger:hover {
          background: rgba(255,255,255,0.1);
          border-color: rgba(255,255,255,0.7);
        }

        .navbar.solid .nav-hamburger:hover {
          background: var(--sand);
